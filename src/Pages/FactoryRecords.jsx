...
const FactoryRecords = () => {
  ...
  return (
        ...
        <Figure low={test2} high={test2} />
          ...
          <ArticleDesc>
          Factory Records - британская звукозаписывающая компания, которая внесла огромный вклад в развитие музыкальной сцены Великобритании, подсадила весь Манчестер на панк-рок, а затем и на электронную музыку, став символом независимой музыки.
          </ArticleDesc>
        ...
        <ArticleMain>
          <ArticleSection>
            ...
            <Figure low={test2} high={test2} />
            <Paragraph>
            В 19 веке Манчестер был городом с процветающей экономикой и считался мировым лидером текстильной промышленности. Здесь находились самые современные хлопчатобумажные фабрики, а манчестерский судоходный канал использовался для перевозки грузов по всей Великобритании.
            </Paragraph>
            <Paragraph>
